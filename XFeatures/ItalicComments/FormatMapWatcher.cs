...
namespace XFeatures.ItalicComments
{
    ...
    internal sealed class FormatMapWatcher
    {
        ...
        internal void FixComments()
        {
            try
            {
                if (SettingsProvider.IsItalicCommentsEnabled() == false)
                {
        ...
        void Italicize(IClassificationType classification)
        {
            ...
            if (SettingsProvider.IsItalicCommentsEnabled() == false)
            {
                if (typeface.Style != FontStyles.Italic)
                    return;
                //remove italic
                newTypeface = new Typeface(new FontFamily("Consolas"), FontStyles.Normal, FontWeights.Normal, typeface.Stretch);
            ...
            {   // If this is already italic, skip it
                ...
                newTypeface = new Typeface(new FontFamily("Lucida Sans"), FontStyles.Italic, FontWeights.Normal, typeface.Stretch);
