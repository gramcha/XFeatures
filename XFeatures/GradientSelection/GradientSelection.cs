...
namespace XFeatures.GradientSelection
{
    ...
    internal sealed class FormatMapWatcher
    {
        ...
        GradientState gstate = GradientState.Disabled;
        ...
        void SetAppropriateBrush()
        {
            ...
            try
            {
                ...
                {
                    if (SettingsProvider.IsGradientSelectionEnabled() == true)
                    {
                        if (gstate == GradientState.Enabled)
                            return;
                        SetGradientBrush();
                        gstate = GradientState.Enabled;
                        return;
                    }
                }
                if (gstate == GradientState.Disabled)
                    return;
                ClearGradientBrush();
                gstate = GradientState.Disabled;
            }
            finally
            {
                inUpdate = false;
