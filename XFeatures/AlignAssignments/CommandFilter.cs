...
namespace XFeatures.AlignAssignments
{
    ...
    class CommandFilter : IOleCommandTarget
    {
        ...
        {
            if (pguidCmdGroup == GuidList.guidXFeaturesCmdSet &&
                nCmdID == PkgCmdIDList.cmdidAlignAssignments && SettingsProvider.IsAlignAssignmentsEnabled())
            {
                AlignAssignments();
        ...
        public int QueryStatus(ref Guid pguidCmdGroup, uint cCmds, OLECMD[] prgCmds, IntPtr pCmdText)
        {
            ...
            {
                if (AssignmentsToAlign && SettingsProvider.IsAlignAssignmentsEnabled())
