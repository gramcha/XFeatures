...
namespace XFeatures.FAFFileOpen
{
    public sealed class SearchEngine : IDisposable
    {
        ...
        public SearchEngine(FAFFileOpenControl notifyControl)
        {
        ...
        private void IndexSolution()
        {
            ...
            Debug.Print("FAFFileOpen.SearchEngine: Indexing...");
            ...
            Debug.Print("FAFFileOpen.SearchEngine: Indexed " + solutionFiles.Count + " solution files in " + stopwatch.Elapsed + ".");
        ...
        private void SearchInternal(string query, int sequence)
        {
            ...
            {
                Debug.Print("FAFFileOpen.SearchEngine: Ignoring outdated search " + sequence);
                return;
            }
            ...
            try
            {
                ...
                Debug.Print("FAFFileOpen.SearchEngine: Search " + sequence + " for: '" + String.Join(" ", positiveTerms) +
            ...
            Debug.Print("FAFFileOpen.SearchEngine: Search " + sequence + " found " + (result == null ? 0 : result.Count()) + " matching files in " + stopwatch.Elapsed + ".");
        ...
        private FAFFileOpenControl notifyControl;
