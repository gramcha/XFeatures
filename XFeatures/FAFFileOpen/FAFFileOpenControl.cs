...
namespace XFeatures.FAFFileOpen
{
    ...
    /// </summary>
    public partial class FAFFileOpenControl : UserControl, IVsUIWin32Element
    {
        private FAF settings { get { return SettingsProvider.GetFAFSettings(); } }
        private SearchEngine searchEngine;
        public FAFFileOpenToolWindow parentWindowPane;
        public string applicationRegistryKey;
        IEnumerable<SolutionFile> resultsRest;

        public FAFFileOpenControl()
        {
            InitializeComponent();
        ...
        {
            System.Diagnostics.Debug.Print("FAFFileOpenControl.InitOnShow() " + this.Visible);

            // (re)index the solution and repeat last search
            searchEngine.Index(andThen: SearchNow);

            uxFiles.CheckBoxes = settings.OpenMultipleFiles;
        ...
        private void OpenSelectedFiles(string editor = null)
        {
            try 
            {
                ...
                else
                {
                    ...
                    foreach (var file in GetSelectedSolutionFiles().ToList())//fixing killing crash
                    {
        ...
        public void ShowResults(IEnumerable<SolutionFile> results)
        {
            ...
            System.Diagnostics.Debug.Print("FAFFileOpen: ListBox populated in " + sw.Elapsed);
        ...
        public void ShowResultsRest(IEnumerable<SolutionFile> results)
        {
            ...
            System.Diagnostics.Debug.Print("FAFFileOpen: ListBox populated with rest in " + sw.Elapsed);
        ...
        {
            System.Diagnostics.Debug.Print("FAFFileOpen: Key strokes typed...");
            SearchNow();
        }
